    ...
    <div class="col-md-12">
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Listado de formularios contactos</div>
            <div class="widget-icons pull-right">
              <span><span class="label label-primary">{{vm.formularios_contactos.length}}</span>  Formularios</span>
            </div>  
...
<!--                   <th ng-click="vm.ordenarTabla('tipo')">Tipo
              ...
              <tbody>
                <tr dir-paginate="formulario in vm.formularios|orderBy:vm.sortKey:vm.reverse|filter:vm.search|itemsPerPage:vm.itemsMostrar">
                 	<td style="text-transform:uppercase;">{{formulario.nombre}}</td> 
...
(function(){
    ...
    function PacientesController($http){
        ...
        vm.formularios_contactos = JSON.parse('<?php echo $formularios_contactos; ?>');
