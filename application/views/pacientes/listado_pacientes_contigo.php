            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                <tr dir-paginate="paciente in vm.pacientes|orderBy:vm.sortKey:vm.reverse|filter:vm.search|itemsPerPage:vm.itemsMostrar" current-page="vm.current_page">
                  <td ng-show="paciente.activo == 1"><a  style="text-transform:uppercase" ng-bind = paciente.nombre ng-href="<?php echo base_url(); ?>pacientes/nuevo_diagnostico/{{paciente.id_paciente}}/{{vm.current_page}}/1/listado_contigo"/></td>
                  <td ng-show="paciente.activo == 0"><a  style="text-transform:uppercase;color:red" ng-bind = paciente.nombre ng-href="<?php echo base_url(); ?>pacientes/nuevo_diagnostico/{{paciente.id_paciente}}/{{vm.current_page}}/1/listado_contigo"/></td>                 <!--  <td> <button class="btn btn-xs btn-success"><i class="icon-ok"></i> </button><button class="btn btn-xs btn-warning"><i class="icon-pencil"></i> </button></td> -->
                  ...
                  <td class="text-center"><span data-ng-repeat="llamado in paciente.llamado" ng-bind = llamado.numero class="label {{llamado.label}}"></span> </td>
                  <td class="text-center" ng-bind = paciente.fecha_registro></td>
                  <td class="text-center">
                      <div class="col-md-12">
                        <a class="btn btn-xs btn-default" ng-href="<?php echo base_url(); ?>pacientes/nuevo_diagnostico/{{paciente.id_paciente}}/{{vm.current_page}}/2/listado_contigo"><i class="icon-pencil"></i></a>
