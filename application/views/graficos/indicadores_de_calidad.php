...
<div class="row">
  <div class="col-md-4" style="margin-bottom: 30px">
    ...
    <select class="form-control" id="opciones">
      <?php 
      $lista[0] = "Porcentaje de pacientes que retomaron su actividad laboral antes de la ostomía en un tiempo de 3 meses";
      $lista[1] = "Porcentaje de pacientes con adherencia al autocuidado de su ostomía";
  ...
  <div class="col-md-2" style="margin-bottom: 30px">
    ...
    <div>
    <a href="<?php echo base_url().'graficos/exportar_indicadores_de_calidad/'.$posicion.'/'.$startDate.'/'.$endDate; ?>" class="btn btn-success">Exportar</a></div>
  </div>
...
<script type="text/javascript">
  ...
  $('select').on('change', function() {
    ...
    url = "<?php echo base_url().'graficos/indicadores_de_calidad/'; ?>" + this.value + "/" + start + "/" + end
    location.href = url
  })

  $("#aplicarDate").click(function(){
    op = $('#opciones').find(":selected").val();
    url = "<?php echo base_url().'graficos/indicadores_de_calidad/'; ?>" + op + "/" + $('#datetimepicker6').data('date') + "/" + $('#datetimepicker7').data('date');
    location.href = url
  })
...
$("#menu_graficos ul li:nth-child(3) a").css("background","#dedede")
</script>