...
<div class="row">
  <div class="col-md-4" style="margin-bottom: 30px">
    ...
    <select class="form-control" id="opciones">
      <?php 
      $lista[0] = "Número de pacientes activos en el programa Contigo";
      $lista[1] = "Número de pacientes con ostomia temporal pendientes por cierre quirúrgico";
      $lista[2] = "Número de pacientes con ostomia definitiva";
      $lista[3] = "Número de pacientes con corrección en la receta de dispositivos para ostomía";
      $lista[4] = "Número de complicaciones estomales evitadas";
  ...
  <div class="col-md-2" style="margin-bottom: 30px">
    ...
    <div>
    <a href="<?php echo base_url().'graficos/exportar_impacto_economico/'.$posicion.'/'.$startDate.'/'.$endDate; ?>" class="btn btn-success">Exportar</a></div>
  </div>
...
<script type="text/javascript">
  ...
  $('select').on('change', function() {
    ...
    url = "<?php echo base_url().'graficos/impacto_economico/'; ?>" + this.value + "/" + start + "/" + end
    location.href = url
  })

  $("#aplicarDate").click(function(){
    op = $('#opciones').find(":selected").val();
    url = "<?php echo base_url().'graficos/impacto_economico/'; ?>" + op + "/" + $('#datetimepicker6').data('date') + "/" + $('#datetimepicker7').data('date');
    location.href = url
  })
...
$("#menu_graficos ul li:nth-child(4) a").css("background","#dedede")
</script>